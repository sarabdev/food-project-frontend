...
import {
  BarChart3, Boxes, ChevronRight, CreditCard, FileStack, LayoutDashboard, Landmark, LogOut,
...
const navigation = [
  ...
  { to: "/bank-accounts", label: "Bank Accounts", icon: CreditCard, permission: "bank_accounts.view" },
